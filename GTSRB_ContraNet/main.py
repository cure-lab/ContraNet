...
def main():
    ...
    parser.add_argument('--checkpoint_folder', type=str, default='./checkpoints/GTSRB_config-train-2021_04_15_10_35_52')
    ...
    parser.add_argument('--seed', type=int, default=3, help='seed for generating random numbers')
