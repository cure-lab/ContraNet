...
def main():
	...
	local_rank = rank
	# adding classifier
	checkpoint_path = "/research/dept6/yjyang/wei_backup/0128_GTSRB_ATTACK"#'/research/dept6/yjyang/SP2020/GTSRB/GTSRBclassifier'
	...
	while step_count <= total_step:
		...
		img_to_classifier = real_images#(real_images  - mean)/std

		acc_of_classifier = fb.utils.accuracy(fmodel, img_to_classifier, real_labels)
