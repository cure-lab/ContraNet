...
def attack_sample(all_sample, model, fmodel, prefix, **kwargs):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help='path to load pretrain checkpoint')
    ...
    params["confidence"] = confidence[0]
    ...
    if len(load_name) > 0:
        ...
        attack_gen(test_loader, fmodel, model, args.save_dir, prefix,
                   "{}_{}".format(args.dataset_name, name), confidence,
                   adversary, no_test=args.no_test)
