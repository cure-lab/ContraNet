...
def attack_gen(test_loader, fmodel, model, adversary, save_dir, prefix, name,
               epsilon_list):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-a', '--arch', default='ContraNet2', type=str)
    ...
    if len(load_name) > 0:
        ...
        load_sample = None
        attack_gen(test_loader, fmodel, model, adversary, args.save_dir,
                   prefix, "{}_{}".format(args.dataset_name, name), epsilon_list)
